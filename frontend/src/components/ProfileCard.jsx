  ...
  return (
    <ModernCard className="w-full xl:w-96 p-0 overflow-hidden relative">
      ...
      <div className="p-4 pt-10 flex flex-col items-center">
        ...
        {/* Contact Me Button: FIX - Height does not change on hover */}
        <button 
          ...
          border-2 border-transparent /* <--- FIX: Added a transparent 2px border here */
          bg-cyan-600 
          text-white 
          ...
          hover:bg-transparent hover:text-cyan-400 hover:border-cyan-400 /* <--- FIX: hover:border-2 is removed as border is already 2px */
