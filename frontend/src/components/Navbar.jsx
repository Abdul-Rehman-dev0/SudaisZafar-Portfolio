...
  const navIcons = {
    home: 'M3 12L12 3L21 12H17V20H7V12H3Z', // Home Icon Path
    about: 'M12 12C14.21 12 16 10.21 16 8S14.21 4 12 4 8 5.79 8 8 9.79 12 12 12ZM12 14C9.33 14 4 15.33 4 18V20H20V18C20 15.33 14.67 14 12 14Z', // About/User Icon Path
    works: 'M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM18 20H6V4H13V9H18V20Z', // Works/File Icon Path
    contact: 'M20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM20 6L12 11L4 6H20Z', // Contact/Email Icon Path
  };
...
  // --- Mobile Navigation Link (Icon Only) ---
...
      >
        {/* Using the locally defined Icon component with SVG paths */}
...
      {/* 📱 Mobile Navigation Bar (Fixed Bottom Border with Icons) */}
